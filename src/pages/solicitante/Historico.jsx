            ...
            <table className="min-w-[800px] w-full table-auto border-collapse bg-white">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-300 text-sm">
                  ...
                  <th className="p-3 text-left whitespace-nowrap">Data Conclusão</th>
                  <th className="p-3 text-left whitespace-nowrap">Valor Final</th>
              ...
              <tbody>
                ...
                <tr className="border-b border-gray-200 hover:bg-gray-50 text-sm">
                  <td className="p-3 whitespace-nowrap font-medium text-gray-700">#1007</td>
                  <td className="p-3 whitespace-nowrap font-semibold">Entrega de Documentos</td>
                  ...
                  <td className="p-3 whitespace-nowrap text-green-700 font-semibold">R$ 55.00</td>
                  ...
                  <td className="p-3 text-center whitespace-nowrap flex justify-center gap-2">
                    ...
                    <button className="text-gray-500 hover:text-gray-700 text-base" title="Gerar Recibo">
                ...
                <tr className="border-b border-gray-200 hover:bg-gray-50 text-sm">
                  <td className="p-3 whitespace-nowrap font-medium text-gray-700">#1008</td>
                  <td className="p-3 whitespace-nowrap font-semibold">Entrega Cancelada</td>
                  ...
                  <td className="p-3 whitespace-nowrap text-gray-500">R$ 0.00</td>
                  <td className="p-3 whitespace-nowrap">
                  ...
                  <td className="p-3 text-center whitespace-nowrap flex justify-center gap-2">
                    ...
                    <button className="text-gray-400 text-base cursor-not-allowed" disabled title="Recibo indisponível">
                      <i className="fas fa-receipt"></i>
                    </button>
                  </td>
                </tr>
