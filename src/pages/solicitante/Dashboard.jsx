...
export default function DashboardSolicitante() {
  ...
  return (
    <div className="min-h-screen flex bg-gray-100">
      {/* SIDEBAR (Mantida a responsividade correta de slide-in) */}
      <aside
        className={`
      ...
      >
        ...
        <nav className="space-y-4 text-lg text-white">
          ...
          <a href="/dashboard/solicitante/pedidos" className="block p-3 rounded-lg hover:bg-blue-500/40 cursor-pointer">
          ...
          <a href="/dashboard/solicitante/historico" className="block p-3 rounded-lg hover:bg-blue-500/40 cursor-pointer">
            <i className="fas fa-history mr-3 text-blue-500"></i>
            Histórico
          </a>
          <a href="/dashboard/solicitante/configuracoes" className="block p-3 rounded-lg hover:bg-blue-500/40 cursor-pointer">
      ...
      <div className="flex-1 flex flex-col md:ml-64 overflow-x-hidden">
        ...
        <header className="bg-blue-700/90 border-b border-blue-700 h-16 flex items-center justify-between px-4 sm:px-6 z-10">
          ...
          <div className="flex items-center gap-4 sm:gap-6">
             <a href="/dashboard/solicitante/notificacoes" className="relative text-xl sm:text-2xl text-blue-500 hover:text-blue-400 transition-all">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div className="bg-white border border-gray-300 p-4 rounded-xl shadow flex items-center gap-3 sm:gap-4 hover:shadow-lg hover:scale-[1.02] transition-all cursor-pointer">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-gray-500 text-xs sm:text-sm truncate">Título do Card</p>
            ...
            <table className="min-w-[800px] w-full table-auto border-collapse bg-white">
              ...
              <tbody>
                <tr className="border-b border-gray-200 hover:bg-gray-50 text-sm">
                  ...
                  <td className="p-3 whitespace-nowrap">Descrição do Pedido 1</td>
                  ...
                  <td className="p-3 whitespace-nowrap">
                    <span className="px-2 py-1 bg-blue-500/40 text-blue-800 rounded-full text-xs font-semibold">Em andamento</span>
                  </td>
                  <td className="p-3 text-center whitespace-nowrap flex justify-center gap-2">
                    <button className="text-blue-700 hover:text-blue-500 text-base"><i className="fas fa-eye"></i></button>
                    <button className="text-blue-700 hover:text-blue-500 text-base"><i className="fas fa-edit"></i></button>
                    <button className="text-red-500 hover:text-red-400 text-base"><i className="fas fa-trash"></i></button>
                  </td>
                </tr>
                <tr className="border-b border-gray-200 hover:bg-gray-50 text-sm">
                  <td className="p-3 whitespace-nowrap">Pedido 2</td>
                  <td className="p-3 whitespace-nowrap">Descrição do Pedido 2</td>
                  ...
                  <td className="p-3 whitespace-nowrap">
                    <span className="px-2 py-1 bg-yellow-500/40 text-yellow-800 rounded-full text-xs font-semibold">Pendente</span>
                  </td>
                  <td className="p-3 text-center whitespace-nowrap flex justify-center gap-2">
                    <button className="text-blue-700 hover:text-blue-500 text-base"><i className="fas fa-eye"></i></button>
                    <button className="text-blue-700 hover:text-blue-500 text-base"><i className="fas fa-edit"></i></button>
                ...
                <tr className="border-b border-gray-200 hover:bg-gray-50 text-sm">
                  ...
                  <td className="p-3 whitespace-nowrap">Descrição do Pedido 3</td>
                  ...
                  <td className="p-3 whitespace-nowrap">
                    <span className="px-2 py-1 bg-green-500/40 text-green-800 rounded-full text-xs font-semibold">Concluído</span>
                  </td>
                  <td className="p-3 text-center whitespace-nowrap flex justify-center gap-2">
                    <button className="text-blue-700 hover:text-blue-500 text-base"><i className="fas fa-eye"></i></button>
                    <button className="text-blue-700 hover:text-blue-500 text-base"><i className="fas fa-edit"></i></button>
