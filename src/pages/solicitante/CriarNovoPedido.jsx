        ...
        <main className="flex-1 overflow-auto p-4 sm:p-6">
          <div className="max-w-4xl mx-auto bg-white border border-gray-300 rounded-xl shadow p-6 sm:p-8 space-y-8">
            ...
            <form className="space-y-6">
                ...
                <div className="space-y-1">
                    <label htmlFor="origem" className="block text-sm font-bold text-blue-700 items-center">
                        <i className="fas fa-map-marker-alt mr-2"></i> Local de Origem <span className="text-red-500 ml-1">*</span>
                    </label>
                    <textarea
                        id="origem"
                        rows="3"
                ...
                <div className="space-y-1">
                    <label htmlFor="destino" className="block text-sm font-bold text-blue-700 items-center">
                        <i className="fas fa-route mr-2"></i> Local de Destino <span className="text-red-500 ml-1">*</span>
                    </label>
                    <textarea
                        id="destino"
                        rows="3"
                ...
                <div className="pt-6 border-t border-gray-200 flex justify-end">
                    ...
                    >
                        <i className="fas fa-check-circle mr-3 text-lg"></i> Enviar Pedido
                    </button>
                </div>
            </form>
          </div>
